...
* **Text Formatting**: While creating cards, users can highlight or emphasize any text with the following formatting options:
   * **Color**: Change the text color to draw attention.
   * **Bold**: Make text bold to emphasize key points.
   * **Italic**: Italicize text for emphasis or stylistic purposes.
   * **Underline**: Underline important text.
   * **Strikethrough**: Strike through text to indicate something incorrect or unimportant.
...
* **Progress Saving**: Your progress is automatically saved. If you quit the quiz, you can return and continue from where you left off.
* **Post-Quiz Learning**: After finishing a quiz, you can revisit and focus specifically on the cards you swiped left during the quiz.
...
* **English and Russian**: The app supports both English and Russian languages, allowing users to choose their preferred language for the interface and instructions.
...
* **Форматирование Текста**: При создании карточек пользователи могут выделять или подчеркивать любой текст с помощью следующих параметров форматирования:
   * **Цвет**: Изменение цвета текста для привлечения внимания.
   * **Полужирный**: Сделать текст полужирным для выделения ключевых моментов.
   * **Курсив**: Сделать текст курсивом для выделения или стилистических целей.
   * **Подчёркивание**: Подчеркнуть важный текст.
   * **Зачёркивание**: Зачеркнуть текст, чтобы указать на что-то неверное или неважное.
...
* **Сохранение Прогресса**: Ваш прогресс сохраняется автоматически. Если вы прерываете сессию, вы можете продолжить с того места, на котором остановились.
* **Обучение После Викторины**: После завершения викторины вы можете вернуться и сосредоточиться на карточках, которые вы пролистали влево во время викторины.

### 3. Организация Модулей
* **Папки**: Группируйте связанные модули в папки для лучшей организации и быстрого доступа. Эта функция идеально подходит для пользователей, которые хотят классифицировать своё обучение по темам, языкам или уровням сложности.
...
* **Английский и Русский**: Приложение поддерживает английский и русский языки, что позволяет пользователям выбрать предпочтительный язык интерфейса и инструкций.
